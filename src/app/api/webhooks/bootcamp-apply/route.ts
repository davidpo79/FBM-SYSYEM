...
const GHL_WEBHOOK_URL = process.env.GHL_WEBHOOK_BOOTCAMP_APPLICATION || process.env.NEXT_PUBLIC_GHL_SMART_WEBHOOK_URL || process.env.NEXT_PUBLIC_GHL_WEBHOOK_URL || "";
